...
public class Product {
    ...
    private BigDecimal productCoast;
    ...
    public Product(Integer id, Integer productGroupId, String productName, String productDescription, Integer productProducerId, Integer countryOriginId, Integer productUnitId, LocalDateTime productArrivalDate, BigDecimal productCoast, BigDecimal productAmount, LocalDateTime productCardDateCreation) {
        this.id = id;
    ...
    public BigDecimal getProductCoast() {
        return productCoast;
    }

    public void setProductCoast(BigDecimal productCoast) {
        this.productCoast = productCoast;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, product.id) && Objects.equals(productGroupId, product.productGroupId) && Objects.equals(productName, product.productName) && Objects.equals(productDescription, product.productDescription) && Objects.equals(productProducerId, product.productProducerId) && Objects.equals(countryOriginId, product.countryOriginId) && Objects.equals(productUnitId, product.productUnitId) && Objects.equals(productArrivalDate, product.productArrivalDate) && Objects.equals(productCoast, product.productCoast) && Objects.equals(productAmount, product.productAmount) && Objects.equals(productCardDateCreation, product.productCardDateCreation);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, productGroupId, productName, productDescription, productProducerId, countryOriginId, productUnitId, productArrivalDate, productCoast, productAmount, productCardDateCreation);
    }
